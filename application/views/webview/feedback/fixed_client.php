...
<section id="mid_content" class="custom_fff">
	<div class="container">
		<div class="row">
				<div style="margin-left: 14px;" class="col-md-9 col-sm-12 margin-top-4 ">
					<div id="wrapper" class="margin-bottom-3 ">
						<div class="row ">
						    <div style="padding-bottom: 19px;border: 1px solid #ccc;border-radius: 4px 4px 0 0px;width: 100%;margin: 0;" class="col-md-9 white-box black-box bordered_top">
						        <div class="wrap-top">
						<div class="row">
							<div class="date_head">
						...
						<div class="row hourlcontact">
							...
							<div style="margin-left: 80px;" class="col-md-3 col-sm-3 col-md-offset-1">
							...
							<div style="margin-left: 80px;" class="col-md-2 col-sm-2 col-md-offset-1">
							...
							<div class="row">
								...
								<?php if(!empty($freelancerfeedback)) { ?>
										<div style="margin-top: -1px;margin-bottom: 10px;margin-left: -43px;" class="col-md-3 col-sm-4" id="feedbackbutton">
											<button style="font-size: 11px;padding: 7px 4px;margin-right: 2px;margin-top: 18px;padding-top: 6px;" type="button" id="butcancel" class="btn btn-danger rating-badge"><?=$freelancerfeedback->feedback_score;?></button>
								...
								<?php }else{?>
										<div style="margin-top: -1px;margin-left: -43px;" class="col-md-4 col-sm-4" id="feedbackbutton">
											<button style="font-size: 11px;padding: 7px 4px;margin-right: 2px;margin-top: 18px;padding-top: 6px;" type="button" id="butcancel" class="btn btn-danger">0.00</button>
											<h4>
							...
							<div class="row">
								...
								<?php if(!empty($clientfeedback)) { ?>
										<div style="margin-top: -1px;margin-bottom: 10px;margin-left: -43px;" class="col-md-5 col-sm-4" id="feedbackbutton">
								...
								<?php }else{?>
										<div style="margin-left: -43px;" class="col-md-4 col-sm-4" id="feedbackbutton">
											<div class="col-md-12 col-sm-12 wdwarfhead wdwarfheadone">
  ...
  <div class="modal-dialog cccc_massage_box">
    <div style="padding: 30px;padding-bottom: 60px;" class="modal-content">
      <div class="modal-header">
			 <button style="margin-top: -50px;margin-right: -27px;" type="button" class="close" data-dismiss="modal" onclick="hidemessagepopup();">&times;</button>
			<h4 style="margin-top: -50px;margin-left: -17px;" class="modal-title">Message</h4>
