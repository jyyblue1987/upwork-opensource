					...
					<div id="wrapper" class="white-box margin-bottom-3 ">
						...
						<div class="row hourlcontact">
							...
							<div class="col-md-3 col-sm-3 col-md-offset-1">
								...
								<h4><?=$total_work;?> Hrs, $<?php echo $weekly_amount = $amount * $total_work;?></h4>
							</div>
							<div class="col-md-2 col-sm-2 col-md-offset-1">
							...
							<div class="col-md-3 col-sm-3 col-md-offset-1">
								<h4> <?=$job->weekly_limit;?> hrs/Week</h4>
							</div>
							</div>
							</div>
						<div class="row">
							...
							<div class="row">
								...
								<?php }else{?>
										<div class="col-md-4 col-sm-4" id="feedbackbutton">
											<div class="col-md-12 col-sm-12 wdwarfhead wdwarfheadone">
												<a href="<?php echo base_url() ?>endhourlyfixed/hourly_freelancer?fmJob=<?php echo base64_encode($job->job_id);?>&buser=<?php echo base64_encode($job->buser_id);?>">
