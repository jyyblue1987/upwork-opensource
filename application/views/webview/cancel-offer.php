<section id="big_header"
	...
	<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-2 text-center gray-text margin-top-4">
						<div class="c_offer_msg hour_btn">
						    <input type="button" class="transparent-btn" onclick="loadmessage(<?=$bid_details[0]->id?>,<?=$freelancer_details[0]->webuser_id?>,<?=$bid_details[0]->job_id?>)" value="Message" />
						</div>
					</div>
		...
		<div class="row ">
			<div class="col-md-9 white-box offer_bordered remove-border-top">

				<div class="row">
					<div class="col-md-12 text-left blue-text">
					   <div class="offer_date">
					        <span class="blue-text">Pending, Expire on <?php echo date(' F j, Y ',strtotime(' + 5 day', strtotime($bid_details[0]->start_date)));?></span>
					   </div>
					</div>
				...
				<div class="row margin-top-2">
				    ...
				    <div class="col-md-8" style="font-size:14px;"><b>$<?=$hourlyreate;?><?=$perHrs;?></b></div>
				</div>
				...
				<div class="row margin-top-2">
				    ...
				    <div class="col-md-8" style="font-size:14px;"><b><?php echo $bid_details[0]->weekly_limit;?></b> Hrs</div>
				</div>
				<?php } ?>
				...
				<div class="row margin-top-2">
				    ...
				    <div class="col-md-8">$<?php echo $bid_details[0]->hired_on;?></div>
				</div>
				...
				<div class="row margin-top-2">
				    ...
				    <div class="col-md-8" ><?php $type = $bid_details[0]->fixed_pay_status;
				...
				<div class="row margin-top-2">
				    ...
				    <div class="col-md-8"><?php if($type == 1 ||$type == 2){ echo '$'.$bid_details[0]->fixedpay_amount;   } else{ echo '$0.00';}?> </div>
				</div>
				<?php } ?>
				<div class="row margin-top-2">
				    <div class="col-md-2 col-md-offset-1">
				    ...
				    <div class="col-md-8"><?php  echo date(' F j, Y ', strtotime($bid_details[0]->start_date)); ?></div>
				</div>
				...
				<div class="row margin-top-2">
				    ...
				    <div class="col-md-8"><?php echo str_replace('_', '-', $job_details[0]->job_duration) ?></div>
				</div>
				<div class="row margin-top-2">
				    <div class="col-md-2 col-md-offset-1">
				    <div class="offer_title">
				    ...
				    <div class="col-md-8"><?php echo $bid_details[0]->hire_message; ?></div>
				</div>
				<div class="row margin-top-2">
