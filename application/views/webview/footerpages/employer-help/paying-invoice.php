			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				...
				<p><u>To pay an invoice:</u></p>

				<p>
					<ol class="help-list">
						<li>Log into your account to view your dashboard (it’s pictured in the image above).
						<li>Look for the “Invoices” tile on the right side.</li>
						<li>Review the invoices listed–this tile lists any invoice that requires any action.</li>
						<li>Click “Pay Now” next to the appropriate invoice.</li>
						<li>Take a moment to review the invoice fully on the next page.</li>
						<li>Click the blue, “Pay Invoice” button and follow the on-screen instructions.</li>
						<li>Managing Invoices</li>
					</ol>
				</p>
				<p>To view or check the status of an invoice, click “Pay” in your navigation bar. You’ll see a list of all invoices for your jobs. You can filter invoices by searching for a job ID or invoice ID.</p>

				<p>To view invoice details, simply click on the invoice ID. If you haven’t paid the invoice yet, you’ll be able to pay, dispute or reject the invoice (if it’s not tied to the agreement). If you’ve already paid it, you can archive or print the invoice.</p>

				<p>Disputing an Invoice</u></p>

				<p>If you’ve received a milestone or hourly invoice and there are funds secured in SafePay, you can dispute the invoice. You can’t dispute miscellaneous invoices.</p>

				<p><u>To dispute an invoice:</u></p>

				<p>
					<ol class="help-list">
						<li>Click on “Pay” in your navigation bar.</li>
						<li>Click on the appropriate invoice ID.</li>
						<li>Click “Dispute”.</li>
						<li>Enter your reasons for disputing the invoice and the amount you’d like refunded if the job isn’t complete.</li>
					</ol>
				</p>
				...
				<p>There are two ways you can add a PO number to a payment.</p>
				...
				<p><u>Via an Invoice</u></p>

				<p>
					<ol class="help-list">
						<li>Log in and view your dashboard.</li>
						<li>Click the “Pay” button to view all of your invoices.</li>
						<li>Select an invoice in which you want to add or change the PO.</li>
						<li>Review the invoice and click “+Purchase Order Number”.</li>
						<li>Add the PO number in the dialogue box that appears and attach a file if needed.</li>
						<li>Click “Save” when finished.</li>
					</ol>
				</p>
			</div>
