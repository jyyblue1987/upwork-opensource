  <form id="form" action="<?=base_url()?>profile/add_experience/<?php if(isset($exp_id))echo $exp_id; ?><?php if(isset($page_from)) echo '/'.$page_from; ?>" method="post" name="experience">
                        <div class=""> 
                                ...
                                <div class="row">
                                        <div class="col-md-9">
                                            <label>Company</label> <input type="text" id="company" name="inputs[company]" value="<?php if(isset($experience->company)) echo $experience->company; ?>" class="form-control" />
                                        </div>
                                </div>

                                <div class="row">
                                        <div class="col-md-9">
                                                <label>Title</label> <input type="text" id="title" name="inputs[title]" value="<?php if(isset($experience->title)) echo $experience->title; ?>" class="form-control" />
                                        </div>
                                </div>

                                <div class="row">
                                        <div class="col-md-9">
                                                <label>Location</label> <input type="text" id="location" name="inputs[location]" value="<?php if(isset($experience->location)) echo $experience->location; ?>" class="form-control" />
                                        </div>
                                </div>
 ...
 <label>Currently I am working here</label> <input type="checkbox" name="inputs[curr_working_place]" <?php if(isset($experience->curr_working_place) && $experience->curr_working_place == 1) echo "checked"; ?> id="curr_working_place" />
                                        </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-9">
                                                ...
                                                <textarea class="form-control" id="description" name="inputs[description]"   rows="6"><?php if(isset($experience->description)) echo $experience->description; ?></textarea>
                                        </div>
                                </div>
