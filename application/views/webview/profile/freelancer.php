					...
					<div class="mainprotfilio-mid-button">
						<div class="">
							<div class="row">
								...
								?>   
									<p class="exp-title"><?php echo $val->title; ?></p>
									<p class="exp-company"><?php echo $val->company; ?></p>
									<p class="exp-year">
											<span>
							...
							if(count($educations)){
								...
								foreach ($educations as $index => $education) {
									...
									<div class="education_head"> 
										...
										<p class="exp-year"><?= $education->dates_attend_from ?> – <?= $education->dates_attend_to ?></p>
