...
function deletefile(file){
	 ...
	 $.ajax({
                type: "POST",
                url: '<?php echo site_url(); ?>delete.php',
                data: 'file=' + file,
		...
		bindImgUploadControl: function(){
			...
			if( !$.isEmptyObject(that.croppedImg)){
				...
				that.cropControlRemoveCroppedImage.on('click',function(){ 
					...
					var filename = $("#imgurl").val().replace(/^.*[\\\/]/, '');
deletefile(filename);
$("#imgurl").val("");
					that.croppedImg = {};
					$(this).hide();
...
var sagar=jQuery.parseJSON(json);
		...
		crop:function(){
			...
			if(typeof FormData == 'undefined'){
				...
				$.ajax({
					...
					var sagar=JSON.parse(_d);
					
					var filename = $("#imgurl").val().replace(/^.*[\\\/]/, '');
deletefile(filename);

	$("#imgurl").val(sagar.url);	
						}				
				}).always(function (data) {
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.obj.append('<img class="croppedImg" src="<?php echo site_url(); ?>' + response.url + '">');
    ...
    <script>
		var croppicHeaderOptions = {
				...
				cropUrl:'<?php echo site_url(); ?>img_crop_to_file.php',
		...
		var croppicContainerPreloadOptions = {
				uploadUrl:'<?php echo site_url(); ?>img_save_to_file.php',
				cropUrl:'<?php echo site_url(); ?>img_crop_to_file.php',
