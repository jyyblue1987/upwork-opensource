    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>jobs-search">Winjob</a>
            </div>

            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo base_url() ?>jobs-search"><i class="fa fa-briefcase" aria-hidden="true"></i> Find Job  </a></li>
    ...
    <div class="container">
        <div class="row"> 
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="menu">
                    <ul>  
                        <li><a href="<?php echo site_url('jobs-search'); ?>" class="current"> Find Jobs  </a></li>      
