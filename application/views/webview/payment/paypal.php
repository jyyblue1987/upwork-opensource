			...
			<div class="col-md-9 bordered">
				<div class="row">
					<div class="col-md-12 margin-left-2">
                                            <h2 class="align-center">Add a verified payment method : <span class="payemnt-method-name" style="text-transform: capitalize;font-size: 30px"></span></h2>
					</div>
		...
		<div class="row margin-left-4">
			<div class="col-md-9 bordered remove-border-top">
				...
				<div class="row margin-top-2">
					<div class="col-md-12 margin-left-2">
						<label>Dont have a Paypal Account</label>? <a href="#">Learn more
							about Paypal Withdrawals</a>
					</div>
				</div>
				...
				<div class="row margin-top-2">
					...
					<div class="col-md-4">
                                            <span class="account-email"><?php echo $this->session->userdata('email'); ?></span><br /> 
                                                <a href="">Not your Paypal Email address?</a>
					</div>
				</div>
				...
				<div class="row margin-top-2">
					<div class="col-md-3 margin-left-2">
						<div class="bordered method-logo">
				...
				<div class="row margin-top-3">
					...
					<div class="col-md-5">
                                            <input type="button" class="btn btn-primary form-btn add-account" value="Add Account" />
