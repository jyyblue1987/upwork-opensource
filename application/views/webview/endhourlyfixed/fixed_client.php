...
<!--  <div class="form-group">
   ...
   <div  style="margin-top: 10px;" class="form-group">
    <label style="margin-left: -60px;" for="" class="col-sm-4 control-label" ><span style="font-size: 21px;font-family: calibri;">Feedback to contactor</span></label>
	</div>
  ...
  <div class="form-group">
    ...
    <div style="margin-left: -11px;" class="col-sm-4 margin-left-10" id="righttextstar">
