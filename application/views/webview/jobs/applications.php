            ...
            <div class="col-md-12 nopadding" >
                <div>
                 <ul class="client-job-activity-current">
                     <li><a class="active-link" href='<?= site_url('jobs/applications/' . $jobId) ?>'>Application (<?= $applicants ?>)</a></li>
                            ...
                            <div class="row margin-top-1">
                                ...
                                <div class="col-md-8 text-left margin-left-1" style="margin-top:-4px;">
                                   <div class="aplicant_identity">
                                        <label class="aplicant_name"><a href="<?php echo base_url() ?>applicants?user_id=<?=base64_encode($value['user_id'])?>&job_id=<?=base64_encode($value['job_id'])?>&bid_id=<?=base64_encode($value['bid_id'])?>"><?php echo ucfirst($value['fname']) . " " . ucfirst($value['lname']) ?></a></label> 
                                    <br/> 
                                    <span>
                                        <b>
                                        <?= $value['tagline']; ?>
                                ...
                                <div class="col-md-2 margin-top-5 text-right msg-buttons">
                                    ...
                                    <div class="hire_sms_btn"><a class="btn btn-primary form-btn" href="<?php echo base_url() ?>applicants?user_id=<?=base64_encode($value['user_id'])?>&job_id=<?=base64_encode($value['job_id'])?>&bid_id=<?=base64_encode($value['bid_id'])?>">Message</a>  
                                    </div>
