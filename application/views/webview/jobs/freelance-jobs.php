            ...
            <div class="col-md-10 col-md-offset-0">
                <div style="margin-top: -23px;" class="row">
                    <div class="col-md-12 no-padding margin-top-search" style="padding: 0px;">
                        <form action="<?= site_url() ?>freelance-jobs?q=<?php echo urlencode($_POST['jobsearchbykeywords']) ?>" method="post" id="job-search-form">
                            <input type="text" placeholder="Find job" name="jobsearchbykeywords" id="jobsearch" value="<?= isset($_POST['jobsearchbykeywords']) ? $_POST['jobsearchbykeywords'] : ''  ?>"  class="form-control search-field" />
