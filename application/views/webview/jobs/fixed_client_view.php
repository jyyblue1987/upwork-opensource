                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            ...
                            foreach ($payments as $payment) {
                                ?>
                                <div style="font-size: 14px;" class="col-md-8 text-centered text-left gray-text"><?php if ($payment->payment_gross == $job_status->bid_amount) {
                                echo "Paid All";
                                ...
                                <div style="font-size: 14px;" class="col-md-2 text-centered text-center gray-text"><?php echo date(' M j, Y ', strtotime($payment->payment_create)); ?></div>
    <?php
}
?>
                        </div>
