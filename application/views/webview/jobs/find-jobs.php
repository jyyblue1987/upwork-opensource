    ...
    <?php if ($job_alert_count) { ?>
                <div class="row">
                    <div class="bordered-alert text-center" style="padding-top:10px;padding-bottom:0;">
    ...
    <?php }?>
            ...
            <form action="find-jobs" method="post" id="job-search-form">
                <div class="row">
                    <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12" style="padding:0;">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-left:0; padding-right:0;">
                    <div class="white-box bordered-feed">
                        <span class="text-center" style="color:#686361;font-weight: bold;font-size: 17px;font-family: calibri;">CATEGORIES</span>
                        <?php
                        if (isset($subCateList) && sizeof($subCateList) > 0 && $subCateList != "") {
                            foreach ($subCateList as $sub) {
                                ?>
                                <div style="margin-bottom: 8px;line-height: 20px;font-size: 16px;font-family: calibri;color:#3863A0!important">
                                    <label class="blue-text"> <a  class="blue-text" href="<?php echo site_url('find-jobs/' . $sub['url_rewrite']) ?>"> <?php echo $sub['subcategory_name'] ?> </a> </label>
                                </div>
                                <?php
                            }
                            ?>
                            <div class="blue-text" style="padding-top: 10px;margin-bottom: 5px;">
                                <label> <a class="blue-text" href="<?php echo site_url("categories/choose") ?>"> <b><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Category </b></a> </label>
                            </div>
                            <?php
                        } else {
                            ?>
                    ...
                    <div class="bordered-feed white-box margin-top-space">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 main-feed">
                    <div class="white-box bordered-feed">
                        <h3>My Job Feed</h3>
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-left:0; padding-right:0;">
                    ...
                    <div class="white-box text-center bordered-feed">
                        <?php
                        ...
                        <div style="margin-top:15px;border: 1px solid #ccc;border-radius: 3px;padding-bottom: 20px;" class='white-box'>
                                <div style="margin-bottom: 8px;" class="no-padding">
                                    <a  class="blue-text" style="color: #3bafdb;font-size: 16px;font-family: calibri;font-weight: bold;" href="<?php echo base_url() ?>Active_interview">Active Interview <p style="float: right;margin: 0;"><?= $no_of_interview ?></p></a>
                                </div>

                                <div style="margin-bottom: 8px;" style="font-size: 14px;" class="gray-text no-padding">
                                    <a class="blue-text" style="color: #3bafdb;font-size: 16px;font-family: calibri;font-weight: bold;" href="<?php echo base_url() ?>jobs/bids_list" style="color:#686361">Proposal Sent <p style="float: right;margin: 0;"><?= $proposals; ?></p></a>
                                </div>

                                <div class="gray-text no-padding">
                                    <label  style="color: #3bafdb;font-size: 16px;font-family: calibri;" class="blue-text">Proposal Limit</label>  <p  class="blue-text" style="font-size: 16px;font-family: calibri;float: right;margin: 0;color: #3bafdb;font-weight: bold;"><?= 30 - $proposals?></p> <label  style="color: #3bafdb;font-size: 16px;font-family: calibri;" class="blue-text">(Monthly)</label>
                                </div>
                                    ...
                                    <div class='row'>
                                        ...
                                        <?php if($profilecompleteness['addpicture'] !=1){ ?>
                                              <div class="col-md-12 element">
                                                 <a class="blue-text" href="<?php echo base_url();?>profile-settings">
                                        ...
                                        <?php if($profilecompleteness['addcat'] !=1){ ?>
                                            <div class="col-md-12 element">
                                                <a class="blue-text" href="<?php echo base_url();?>categories/choose">
                                                    <i class="fa fa-plus-circle" aria-hidden="true"></i> Add
                                                    Categories
                                                </a>
                                            </div>
                                        ...
                                        <?php if($profilecompleteness['addportfolio'] !=1){ ?>
                                            <div class="col-md-12 element">
                                                <a class="blue-text" href="<?php echo base_url();?>profile/basic_bio">
                                                    <i class="fa fa-plus-circle" aria-hidden="true"></i> Add
                                                    Portfolios
                                                </a>
                                            </div>
