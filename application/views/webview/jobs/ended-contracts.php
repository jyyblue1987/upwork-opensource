	...
	<div class="container">
		<div class="row ">
			...
			<div class="ec_custom_body">
				<div class="row">
					<div style="margin-left: -2px ! important; margin-bottom: 0px; padding-top: 7px; padding-bottom: 0px;width: 737px;margin-top: 8px;height: 40px;" class="col-md-12 bordered-alert text-center ack-box">
						<?php if($past_hire){ ?>
				...
				<div class="row margin-top-2">
					<div class="col-md-12 white-box ec_white_box" style="padding: 20px;margin-left: -4px;">
						<div class="row">
							<div class="col-md-4">
								<div class="row">
									<div class="col-md-5">
									...
									<div class="col-md-7 nopadding" style="padding-left: 0px !important">
										<div style="padding-left: 2px;font-family: calibri;" class="user_name">
