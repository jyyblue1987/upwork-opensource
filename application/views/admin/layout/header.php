...
<head>
  ...
  <!-- Plugins -->
  <link rel="stylesheet" href="<?php echo site_url("assets/css/perfect-scrollbar.min.css"); ?>">
  ...
  <script src="<?php echo site_url("assets/js/perfect-scrollbar.jquery.min.js"); ?>"></script>
