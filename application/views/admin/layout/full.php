...
<body>
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail margin-0" href="javascript:void(0)">
                            <img class="width-full" src="<?php echo site_url("assets/global/photos/placeholder.png"); ?>" alt="..."
                            />
                          </a>
                        </li>
                        <li>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-online">
                            <img src="<?php echo site_url("assets/global/portraits/2.jpg"); ?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-off">
                            <img src="<?php echo site_url("assets/global/portraits/3.jpg"); ?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="<?php echo site_url("assets/global/portraits/4.jpg"); ?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
          ...
          <li id="toggleChat">
            <a data-toggle="site-sidebar" href="javascript:void(0)" title="Chat" data-url="<?php echo site_url("site-sidebar.tpl"); ?>">
  ...
  <script src="<?php echo site_url("assets/global/js/components/input-group-file.js"); ?>"></script>
  <script>
