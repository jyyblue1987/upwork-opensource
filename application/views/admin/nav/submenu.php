  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">System Submenu</h1>
...
?>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Add Submenu</h3>
            </div>
			...
			if($errormsg=="na"){
				  ...
				  ?>
            <form class="form-horizontal" id="exampleStandardForm" method="post" action="<?php echo site_url("administrator/nav/addsubmenu?id=".$_GET['id']); ?>" autocomplete="off">


        <?php
			  echo $this->Adminforms->inputtext("Sub Page","subpage","Enter Sub page","",1);
        echo $this->Adminforms->inputtext("Name","name","Enter Name","",1);
			  ...
			  echo $this->Adminforms->toggle("Menu","menu",1);
			...
			<br>
<h2 style="text-align:center;">ADD/EDIT/DELETE/INACTIVE</h2>
			  
            <form class="form-horizontal" id="exampleStandardForm" method="post" action="<?php echo site_url("administrator/nav/addsubmenubulk?id=".$_GET['id']); ?>" autocomplete="off">
			<?php
			echo $this->Adminforms->inputtext("Name","name","Enter Name","",1);
			echo $this->Adminforms->submit("Add");
			  ?>
              </form>
      ...
      <h1 class="page-title">User Submenu List</h1>
    </div>
...
<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
				  ...
				  <div class="fixed-table-body"><div class="fixed-table-loading" style="top: 37px; display: none;">Loading, please wait...</div><table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover">
                    <thead>
                      <tr>
            					  ...
            					  <th style=""><div class="th-inner ">subPage</div><div class="fht-cell"></div></th>
            					  <th style=""><div class="th-inner ">Name</div><div class="fht-cell"></div></th>
            					  <th style=""><div class="th-inner ">Menu</div><div class="fht-cell"></div></th>
 ...
 $this->db->select('id,page,subpage,name,menu,ind,icon');
 $this->db->from('usersubpage');
 if(isset($_GET['q'])){
$q=$_GET['q'];
 $this->db->like('name', $q);
 ...
 <textarea style="width:100%;height:100px;padding:15px;">
					case "<?php echo $this->Adminforms->getdata("page","userpage",$_GET['id']); ?>":
					$permission=array(<?php
$pernum=0;
   if($query -> num_rows() > 0)
   {
...
foreach ($query->result() as $value) {
	  ...
	  ?>
				  <tr data-index="0">
            				  ...
            				  <td style=""><input value="<?php echo $value->id; ?>"></td>
            				  <td style=""><?php echo $value->ind; ?></td>
            				  <td style="">
                        <i class="icon <?php echo $value->icon; ?>" aria-hidden="true"></i></td>
            				  <td style=""><?php echo $value->subpage; ?></td>
            				  <td style=""><?php echo $value->name; ?></td>
            				  <td style=""><?php echo $value->menu==1 ? "on" : "off" ; ?></td>
				  <td style="">
						...
						<a href="<?php echo site_url('administrator/nav/editsubmenu?id='.$value->id.'&page='.$_GET['id']); ?>">
