...
<?php
	...
	echo $this->Adminforms->inputtext("Package Name","packages_name","Enter Name",$result[$db."_name"],1);
	echo $this->Adminforms->inputtext("Package Index","packages_index","Enter Index",$result[$db."_index"],1);
...
?>
 ...
 echo $this->Adminforms->selectgrpb("User count","packages_unlimiteduser",$limun,$result["packages_unlimiteduser"],true,"User count","showhidesysuser(this.value);");
			  	?><div id="sysuserq"  <?php if($result["packages_unlimiteduser"]==2){ echo ' style="display:none;"'; } ?>><?php 
			  
	echo $this->Adminforms->inputtextnr("User count","packages_user","Enter quantity",$result["packages_user"],1,"");
	...
	echo $this->Adminforms->inputpricenr("Monthly payment","packages_pricequter","Monthly payment",$result["packages_pricequter"],1);
echo $this->Adminforms->inputpricenr("Yearly payment","packages_priceyear","Yearly payment",$result["packages_priceyear"],1);
echo $this->Adminforms->inputpricenr("Yearly paymentupgrade","packages_priceyearupgrade","Yearly payment Upgrade",$result["packages_priceyearupgrade"],1);
