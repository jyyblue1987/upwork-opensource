				...
				if(isset($_GET['q'])){
				  ...
				  ?></caption>
				   ...
				   <thead>
					  ...
					  <th style=""><div class="th-inner ">First Name</div><div class="fht-cell"></div>
					  <th style=""><div class="th-inner ">Last Name</div><div class="fht-cell"></div>
					  <th style=""><div class="th-inner ">UserName</div><div class="fht-cell"></div>
					  <th style=""><div class="th-inner ">Email</div><div class="fht-cell"></div>
					  <th style=""><div class="th-inner ">Type</div><div class="fht-cell"></div>
                    </thead>
                  <tbody>
...
foreach ($result['data'] as  $value) {
	$arrdata=(array) $value;
	  ?>
				  ...
				  <td style=""><b><?php echo $arrdata[$qdata['db']."_fname"]; ?></b></td>
				  <td style=""><b><?php echo $arrdata[$qdata['db']."_lname"]; ?></b></td>
				  <td style=""><b><?php echo $arrdata[$qdata['db']."_username"]; ?></b></td>
				  <td style=""><b><?php echo $arrdata[$qdata['db']."_email"]; ?></b></td>
				  <td style=""><b><?php echo ($arrdata[$qdata['db']."_type"]==1? "Employee" : "Freelancer"); ?></b></td>
