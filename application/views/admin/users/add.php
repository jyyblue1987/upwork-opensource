        ...
        <div class="col-md-6">
          ...
          <div class="panel">
			...
			if($errormsg=="na"){
				  ...
				  ?>
            <form class="form-horizontal" id="exampleStandardForm" method="post" action="<?php echo site_url("administrator/users/loadpage/addcheck"); ?>"  enctype="multipart/form-data" autocomplete="off">
              <?php
			  ...
			  echo $this->Adminforms->selectdbnew("Select Country","country","Select Country","country","id","name","index","asc","",true,array("all","All Country"));
