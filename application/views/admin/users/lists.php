        ...
        <div class="panel-body container-fluid">
          <div class="row row-lg">
				...
				<div class="bootstrap-table"><div class="fixed-table-toolbar"><div class="bars pull-left"><div class="btn-group hidden-xs" id="exampleToolbar" role="group">
                   <a href="<?php echo site_url('administrator/users/loadpage/add'); ?>"> <button type="button" class="btn btn-outline btn-default">
                      <i class="icon fa-plus" aria-hidden="true"></i>
                    </button></a>
                   <a href="<?php echo site_url('administrator/users/loadpage/inactiveadmin'); ?>"><button type="button" class="btn btn-outline btn-default">
                      <i class="icon fa-trash" aria-hidden="true"></i>
				  	  ...
				  	  <form method="GET" action="<?php echo site_url('administrator/users/loadpage/lists'); ?>" id="search">
...
foreach ($query->result() as $value) {
	  ...
	  ?>
				  ...
				  <td style="">
						...
						<a href="<?php echo site_url('administrator/users/loadpage/edit?id='.$value->id); ?>">
                          <button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Edit">
                            <i class="icon fa-edit" aria-hidden="true"></i>
                          </button>
                          </a>
						  <a href="<?php echo site_url('administrator/users/loadpage/inactive?id='.$value->id); ?>">
                          <button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="Delete">
                            <i class="icon fa-trash" aria-hidden="true"></i>
                          </button>
                          </a>
						  <a href="<?php echo site_url('administrator/users/loadpage/permission?id='.$value->id); ?>">
                          <button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                          data-original-title="User Permission">
				...
				<li class="page-first"><a href="<?php echo site_url('administrator/users/loadpage/lists?start=0'.$qapend); ?>">«</a></li>
				<li class="page-pre"><a href="<?php echo site_url('administrator/users/loadpage/lists?start='.$prev.$qapend); ?>">‹</a>
				</li><li class="page-number disabled"><a href="javascript:void(0)">...</a></li>
				<li class="page-next"><a href="<?php echo site_url('administrator/users/loadpage/lists?start='.$next.$qapend); ?>">›</a></li>
				<li class="page-last"><a href="<?php echo site_url('administrator/users/loadpage/lists?start='.$last.$qapend); ?>">»</a></li>
				</ul></div></div>
