        ...
        <div class="panel-body container-fluid">
          <div class="row row-lg">
				...
				<div class="bootstrap-table"><div class="fixed-table-toolbar"><div class="bars pull-left"><div class="btn-group hidden-xs" id="exampleToolbar" role="group">
                   ...
                   <a href="<?php echo site_url('administrator/users/loadpage/lists/'); ?>"><button type="button" class="btn btn-outline btn-default">
                      <i class="icon fa-user" aria-hidden="true"></i>
				  	  ...
				  	  <form method="GET" action="<?php echo site_url('administrator/users/loadpage/inactiveadmin'); ?>" id="search">
...
foreach ($query->result() as $value) {
	  ...
	  ?>
				  ...
				  <td style="">
						  ...
						  <a href="<?php echo site_url('administrator/users/loadpage/active?id='.$value->id); ?>">
				...
				<li class="page-first"><a href="<?php echo site_url('administrator/users/loadpage/inactiveadmin?start=0'.$qapend); ?>">«</a></li>
				<li class="page-pre"><a href="<?php echo site_url('administrator/users/loadpage/inactiveadmin?start='.$prev.$qapend); ?>">‹</a>
				</li><li class="page-number disabled"><a href="javascript:void(0)">...</a></li>
				<li class="page-next"><a href="<?php echo site_url('administrator/users/loadpage/inactiveadmin?start='.$next.$qapend); ?>">›</a></li>
				<li class="page-last"><a href="<?php echo site_url('administrator/users/loadpage/inactiveadmin?start='.$last.$qapend); ?>">»</a></li>
				</ul></div></div>
