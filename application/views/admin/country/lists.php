				...
				if(isset($_GET['q'])){
				  ...
				  ?></caption>
				   ...
				   <thead>
					  ...
					  <th style=""><div class="th-inner ">Dialing code</div><div class="fht-cell"></div>
					  <th style=""><div class="th-inner ">Currency</div><div class="fht-cell"></div>
					  <th style=""><div class="th-inner ">Coverage</div><div class="fht-cell"></div>
...
foreach ($result['data'] as  $value) {
	$arrdata=(array) $value;
	  ?>
				  ...
				  <td style=""><b><?php echo $arrdata[$qdata['db']."_name"]; ?> (<?php echo $arrdata[$qdata['db']."_shortcode"]; ?>)</b></td>
				  <td style=""><?php echo $arrdata[$qdata['db']."_dialingcode"]; ?></td>
				  <td style=""><?php echo $arrdata[$qdata['db']."_currency"]; ?> (<?php echo $arrdata[$qdata['db']."_currencycode"]; ?>)</td>
          <td style=""><?php switch ($arrdata[$qdata['db']."_avaliable"]) {
    case "1":
        echo "Avaliable";
        break;
    case "2":
