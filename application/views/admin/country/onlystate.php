      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="panel">
            ...
            <form class="form-horizontal" id="exampleStandardForm" method="post" action="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/addstates/?id='.$_GET['id']); ?>"  enctype="multipart/form-data" autocomplete="off">
              <?php
	  ...
	  ?>
				  ...
				  <div style="float:left;"><b><?php echo $arrdata[$qdata['db']."_name"]; ?></b></div>
				    ...
				    <div class="pull-right search">
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/deletestate?country='.$_GET['id'].'&id='.$arrdata[$qdata['db']."_id"]); ?>">
                          <button type="button" class="btn btn-danger" data-toggle="tooltip"
                          data-original-title="Delete State">Delete</button>
                          </a>
					</div>
				  
				   <form method="POST" action="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/editstates?country='.$_GET['id'].'&id='.$arrdata[$qdata['db']."_id"]); ?>" id="search">
	...
	$arrdata=(array) $value;
	  ?>
				  ...
				  <td style="">
						  ...
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/restorestate?country='.$_GET['id'].'&id='.$arrdata[$qdata['db']."_id"]); ?>">
                          <button type="button" class="btn btn-success" data-toggle="tooltip"
                          data-original-title="Restore State">Restore</button>
                          </a>
					
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/delstate?country='.$_GET['id'].'&id='.$arrdata[$qdata['db']."_id"]); ?>">
                          <button type="button" class="btn btn-danger" data-toggle="tooltip"
                          data-original-title="Delete State">Delete</button>
                          </a>
