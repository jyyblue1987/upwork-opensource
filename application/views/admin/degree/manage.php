  ...
  <div class="page animsition">
    <div class="page-header">
	  ...
	  <h1><?php  echo $this->Adminforms->getdetdata("degree_name","degree","degree_id",$_GET['id']); ?></h1>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="panel">
            ...
            <form class="form-horizontal" id="exampleStandardForm" method="post" action="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/adddepartment/?id='.$_GET['id']); ?>"  enctype="multipart/form-data" autocomplete="off">
              <?php
	...
	echo $this->Adminforms->inputtext(ucfirst($val),$db."_".$val,"Enter ".ucfirst($val),"",1);
			  ...
			  echo $this->Adminforms->submit("Add Department");
    ...
    <div class="page-header">
      <h1 class="page-title">Active Department</h1>
	  ...
	  ?>
				  ...
				  <td style="">
				    ...
				    <div class="pull-right search">
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/deletedepartment?country='.$_GET['id'].'&id='.$value[$qdata['db']."_id"]); ?>">
                          <button type="button" class="btn btn-danger" data-toggle="tooltip"
                          data-original-title="Delete State">Delete</button>
                          </a>
					</div>

				   <form method="POST" action="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/editdepartment?country='.$_GET['id'].'&id='.$value[$qdata['db']."_id"]); ?>" id="search">
				  ...
				  <td style="">Add Courses</td>
				  <td style="">


					<form method="POST" action="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/addcoursesunder?degree='.$_GET['id'].'&department='.$value[$qdata['db']."_id"]); ?>" id="search">
							  <div class="pull-left search"><input class="form-control input-outline" name="name" type="text" placeholder="Courses name" value=""></div>
	...
	$arrdata=(array) $valueactive;
	  ...
	  ?>
				  ...
				  <div style="float:left;"><?php echo $arrdata[$qdata['subdb']."_name"]; ?></div>
				    ...
				    <div class="pull-right search">
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/deletecourses?degree='.$_GET['id'].'&id='.$arrdata[$qdata['subdb']."_id"]); ?>">
                          <button type="button" class="btn btn-danger" data-toggle="tooltip"
                          data-original-title="Delete State">Delete</button>
                          </a>
					</div>

				   <form method="POST" action="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/editcourses?degree='.$_GET['id'].'&id='.$arrdata[$qdata['subdb']."_id"]); ?>" id="search">
...
foreach ($value['inactive'] as  $valueactive) {
	$arrdata=(array) $valueactive;
	  ...
	  ?>
				  ...
				  <div style="float:left;"><?php echo $arrdata[$qdata['subdb']."_name"]; ?></div>
				    ...
				    <div class="pull-right search">
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/delcourses?degree='.$_GET['id'].'&id='.$arrdata[$qdata['subdb']."_id"]); ?>">
                          <button type="button" class="btn btn-danger" data-toggle="tooltip"
                          data-original-title="Delete Courses">Delete</button>
                          </a>
					</div>
				    <div class="pull-right search">
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/restorecourses?degree='.$_GET['id'].'&id='.$arrdata[$qdata['subdb']."_id"]); ?>">
                          <button type="button" class="btn btn-success" data-toggle="tooltip"
                          data-original-title="Restore Courses">Restore</button>
                          </a>
					</div>
    ...
    <div class="page-header">
      <h1 class="page-title">Inactive Department</h1>
	...
	$arrdata=(array) $value;
	  ?>
				  ...
				  <td style="">
						  ...
						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/restoredepartment?country='.$_GET['id'].'&id='.$arrdata[$qdata['db']."_id"]); ?>">
                          <button type="button" class="btn btn-success" data-toggle="tooltip"
                          data-original-title="Restore State">Restore</button>
                          </a>

						  <a href="<?php echo site_url('administrator/userpage/loadpage/'.$loadpage.'/subpage/deldepartment?country='.$_GET['id'].'&id='.$arrdata[$qdata['db']."_id"]); ?>">
                          <button type="button" class="btn btn-danger" data-toggle="tooltip"
                          data-original-title="Delete State">Delete</button>
                          </a>
