  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <h2>Reset Your Password </h2>
         <p>Give us your new password</p>

     		<?php if(isset($errormsg)){ if($errormsg==""){}else{	?><p style="color:red;"><?php echo $errormsg; ?></p><?php }} ?>

      <form method="post" role="form" action="<?php echo site_url("administrator/login/resetcheck/?token=".$token); ?>" autocomplete="off">
        <div class="form-group form-material floating">
          ...
          <div class="form-group form-material floating">
            <input type="password" class="form-control empty" name="vpassword" id="vpassword">
            <label class="floating-label" for="vpassword">Verify New Password</label>
          </div>
