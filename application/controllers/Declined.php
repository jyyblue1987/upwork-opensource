            ...
            foreach($rejects['data'] AS $_rejects){
               ...
               foreach($accepted_jobs AS $a_jobs){
				...
				$applicant = [
					...
					'profile_url' => site_url("applicants?user_id=") . base64_encode($_rejects->webuser_id) . "&job_id=" . base64_encode($this->job_details->get_jobid()) . "&bid_id=" . base64_encode($_rejects->id),
